...
foreach ($envio['recibo'] as $key => $value) {
	$pdf->AddPage();
	$pdf->setPrintFooter(false);
	...
	$pdf->SetFont('Times','B',11);
	$pdf->MultiCell(140, 1, "Nit: 811023661-1 Regimen Común", 0, 'C', 0, 0, '40', '11', true);
	$pdf->MultiCell(17, 1, "Numero:", 0, 'L', 0, 0, '1', '21', true);
	$pdf->MultiCell(16, 1, "Destino:", 0, 'L', 0, 0, '41', '21', true);
	$pdf->MultiCell(17, 1, "Persona:", 0, 'L', 0, 0, '116', '21', true);
	$pdf->MultiCell(13, 1, "Pago:", 0, 'L', 0, 0, '150', '21', true);
	$pdf->MultiCell(17, 1, "Usuario:", 0, 'L', 0, 0, '1', '31', true);
	$pdf->MultiCell(13, 1, "Flete:", 0, 'L', 0, 0, '101', '31', true);
	$pdf->MultiCell(15, 1, "Fecha:", 0, 'L', 0, 0, '134', '31', true);

	if($envio['reciboInfo']['tipo'] == 'Natural'){
		$pdf->MultiCell(17, 1, "Placa:", 0, 'L', 0, 0, '1', '26', true);
		$pdf->MultiCell(30, 1, "Conductor CC:", 0, 'L', 0, 0, '41', '26', true);
		$pdf->MultiCell(23, 1, "Conductor:", 0, 'L', 0, 0, '101', '26', true);
	} else {
		$pdf->MultiCell(17, 1, "Nit:", 0, 'L', 0, 0, '1', '26', true);
		$pdf->MultiCell(22, 1, "Razón social:", 0, 'L', 0, 0, '41', '26', true);
	}
//	$pdf->MultiCell(20, 1, "Flete:", 0, 'L', 0, 0, '91', '26', true);
//	$pdf->MultiCell(36, 1, "Fecha:", 0, 'L', 0, 0, '111', '26', true);
	...
	if($envio['reciboInfo']['tipo'] == 'Natural'){
		$pdf->MultiCell(30, 1,$envio['reciboInfo']['negociador'], 0, 'L', 0, 0, '71', '26', true);
		$pdf->MultiCell(83, 1,$envio['reciboInfo']['negociador_nom'], 0, 'L', 0, 0, '124', '26', true);
	} else {
		$pdf->MultiCell(18, 1,$envio['reciboInfo']['razon'], 0, 'L', 0, 0, '56', '26', true);
	}
	$pdf->MultiCell(23, 1,$envio['reciboInfo']['documento'], 0, 'L', 0, 0, '18', '26', true);


	$pdf->MultiCell(23, 1,$envio['reciboInfo']['numero'], 0, 'L', 0, 0, '18', '21', true);
	$pdf->MultiCell(60, 1,$envio['reciboInfo']['destino'], 0, 'L', 0, 0, '56', '21', true);
	$pdf->MultiCell(18, 1,$envio['reciboInfo']['tipo'], 0, 'L', 0, 0, '132', '21', true);
	$pdf->MultiCell(20, 1,$envio['reciboInfo']['forma_pago'], 0, 'L', 0, 0, '163', '21', true);
	
	$pdf->MultiCell(80, 1,$envio['reciboInfo']['user'], 0, 'L', 0, 0, '17', '31', true);
	$pdf->MultiCell(20, 1,$envio['reciboInfo']['flete'], 0, 'L', 0, 0, '114', '31', true);
	$pdf->MultiCell(36, 1,$envio['reciboInfo']['fecha'], 0, 'L', 0, 0, '149', '31', true);

	$pdf->Line(1, 21, ($largoM-9), 21, null);
	$pdf->Line(1, 36, ($largoM-9), 36, null);
	$pdf->Line(1, 46, ($largoM-9), 46, null);
	...
	$pdf->SetXY(1,41);
	$pdf->Cell(19, 1, $guia, 0, 1, 'C', 0, '', 1);
	$pdf->SetXY(20,41);
	$pdf->Cell(51, 1, $destinatario, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(71,41);
	$pdf->Cell(42, 1, $direccionD, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(113,41);
	$pdf->Cell(30, 1, $destino, 0,1,'L',0,'',1);
	$pdf->SetXY(143,41);
	$pdf->Cell(19, 1, $telefonoD1, 0,1,'L',0,'',1);
	$pdf->SetXY(162,41);
	$pdf->Cell(8, 1, $cantidad, 0,1,'L',0,'',1);
	$pdf->SetXY(170,41);
	$pdf->Cell(22, 1, $empaque, 0,1,'L',0,'',1);
	$pdf->SetXY(192,41);
	$pdf->Cell(14, 1, $valorTotal, 0,1,'R',0,'',1);
	$pdf->MultiCell(36, 1,$value, 0, 'L', 0, 0, '172', '46', true);
