...
<div class="row" style="width:90%; margin-left:5%;">
	...
	<?php echo $this->Form->create('Contabl',array('class'=>'form-inline'));?>
		<div><h3><center>EGRESOS</center></h3></div>
		...
		<div class="form-group col-md-12">
			<div class="col-md-8"><?php echo $this->Form->input('iva',array('label'=>false,'type'=>'text','default'=>"IVA",'readonly'=>'readonly','tabindex'=>"-1",'class'=>'form-control','data-bv-notempty'=>'true')); ?></div>
			<div class="col-md-4"><?php echo $this->Form->input('valor_iva',array('label'=>false,'default'=>'0','type'=>'text','class'=>'form-control valor')); ?></div>
		</div>
		<div class="form-group col-md-12">
			<div class="col-md-8"><?php echo $this->Form->input('xcompra',array('label'=>false,'type'=>'text','default'=>"RETENCIÓN X COMPRAS",'readonly'=>'readonly','tabindex'=>"-1",'class'=>'form-control','data-bv-notempty'=>'true')); ?></div>
		...
		<div class="form-group col-md-12">
			<div class="col-md-8"><?php echo $this->Form->input('xservicios',array('label'=>false,'type'=>'text','default'=>"RETENCIÓN X SERVICIOS",'readonly'=>'readonly','tabindex'=>"-1",'class'=>'form-control','data-bv-notempty'=>'true')); ?></div>
