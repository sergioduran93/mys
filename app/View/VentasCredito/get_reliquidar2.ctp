	...
	<div style="margin: 0px 30px;">
		<div class="bs-callout bs-callout-warning" style="margin:2px 0px 2px 0px;padding: 0px 5px;">
			...
			<div class="form-group col-md-12">
				<div class="col-md-4"><h4 class="traz"><span>Doc cliente: </span><small><?php echo $this->data['VentasCredito']['documentoClien'] ?></small></h4></div>
				<div class="col-md-4"><h4 class="traz"><span>Nombre cliente: </span><small><?php echo $this->data['VentasCredito']['nombreClien'] ?></small></h4></div>
				<div class="col-md-4"><h4 class="traz"><span>Dirección cliente: </span><small><?php echo $this->data['VentasCredito']['direccionClien'] ?></small></h4></div>
			</div>
			<div class="form-group col-md-12">
				<div class="col-md-3"><h4 class="traz"><span>Origen: </span><small><?php echo $this->data['VentasCredito']['origenNombre'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Teléfono cliente: </span><small><?php echo $this->data['VentasCredito']['telefonoClien'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Fax cliente: </span><small><?php echo $this->data['VentasCredito']['faxClien'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Email cliente: </span><small><?php echo $this->data['VentasCredito']['emailClien'] ?></small></h4></div>
			</div>
		</div>
		<div class="bs-callout bs-callout-info" style="margin:2px 0px 2px 0px;padding: 0px 5px;">
			...
			<div class="form-group col-md-12">
				<div class="col-md-4"><h4 class="traz"><span>Doc destinatario: </span><small><?php echo $this->data['VentasCredito']['documentoDest'] ?></small></h4></div>
				<div class="col-md-4"><h4 class="traz"><span>Nombre destinatario: </span><small><?php echo $this->data['VentasCredito']['nombreDest'] ?></small></h4></div>
				<div class="col-md-4"><h4 class="traz"><span>Dirección destinatario: </span><small><?php echo $this->data['VentasCredito']['direccionDest'] ?></small></h4></div>
			</div>
			<div class="form-group col-md-12">
				<div class="col-md-3"><h4 class="traz"><span>Destino: </span><small><?php echo $this->data['VentasCredito']['origenNombre'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Teléfono destinatario: </span><small><?php echo $this->data['VentasCredito']['telefonoDest'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Fax destinatario: </span><small><?php echo $this->data['VentasCredito']['faxDest'] ?></small></h4></div>
				<div class="col-md-3"><h4 class="traz"><span>Email destinatario: </span><small><?php echo $this->data['VentasCredito']['emailDest'] ?></small></h4></div>
			</div>
		</div>
		<div class="bs-callout bs-callout-green" style="margin:2px 0px 2px 0px;padding: 0px 5px;">
			<div class="form-group col-md-12">
				<div class="col-md-6"><h4 class="traz"><span>Valor Declarado: </span><small><?php echo $this->data['VentasCredito']['declarado'] ?></small></h4></div>
				<div class="col-md-6"><h4 class="traz"><span>Valor Devolución: </span><small id="devolSpan"><?php echo $this->data['VentasCredito']['valor_devolucion'] ?></small></h4></div>
			</div>
		</div>
	</div>
...
<script>
	...
	var costoSeguro   = 0;
	var declarado     = <?php echo floatval($this->data['VentasCredito']['declarado']); ?>;
	var firmado       = <?php echo '"'.$this->data['VentasCredito']['firmado'].'"'; ?>;
...
//	viewModel.addUser();
/*
	$('#VentasCreditoGetReliquidarForm').bootstrapValidator({
		framework: 'bootstrap',
		excluded: ':disabled',
		feedbackIcons: {
...
*/
	...
	$.each($(".empaques"),function(key,value){
		...
		var pesoVolAux = ((empaquesKO[key].largo/100)*(empaquesKO[key].ancho/100)*(empaquesKO[key].alto/100))*400*empaquesKO[key].cantidad;
