...
<?php echo $this->Form->create('VentasCredito',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
	...
	<div style="margin: 0px 30px;">
		...
		<div class="bs-callout bs-callout-info" style="margin:2px 0px 2px 0px;padding: 0px 5px;">
			...
			<div class="form-group col-md-12">
				<div class="col-md-3"><h4 class="traz"><span>Destino: </span><small><?php echo $this->data['VentasCredito']['destinoNombre'] ?></small></h4></div>
...
<script>
	...
	var costoSeguro   = 0;
	var declarado     = <?php echo floatval(str_replace(",", "",$this->data['VentasCredito']['declarado'])); ?>;
...
*/
	...
	if(ajaxCall.Tarifa.length > 0){
		...
		if(firmado == "Si"){
			...
			$('#VentasCreditoValorDevolucion').val(0);
		}
