...
<div class="row" style="width:90%; margin-left:5%;">
	...
	<?php echo $this->Form->create('VentasCredito',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
		<div><h3><center>VENTAS DE CLIENTES</center></h3></div>
	    ...
	    <div class="form-group col-md-12">
			<div class="col-md-20"><?php echo $this->Form->input('remesa',array('label'=>'Remesa No.: ','type'=>'text','readonly'=>'readonly')); ?></div>
		...
		<div class="bs-callout bs-callout-warning" style="margin: 10px 0px 5px 30px;padding:2px;">
		    ...
		    <div class="form-group col-md-12">
				<div class="col-md-3"><?php echo $this->Form->input('documentoClien',array('label'=>'Documento: ','type'=>'text','readonly'=>'readonly')); ?></div>
				<div class="col-md-6"><?php echo $this->Form->input('nombreClien',array('label'=>'Nombre: ','type'=>'text','readonly'=>'readonly')); ?></div>
				<div class="col-md-3"><?php echo $this->Form->input('direccionClien',array('label'=>'Dirección: ','type'=>'text','readonly'=>'readonly')); ?></div>
			</div>
		    <div class="form-group col-md-12">
				<div class="col-md-3"><?php echo $this->Form->input('telefonoClien',array('label'=>'Teléfono:','type'=>'text','readonly'=>'readonly')); ?></div>
			...
			<table class='contactsEditor'>
		        ...
		        <tbody data-bind="foreach: users">
		            <tr>
						...
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('cantidad.',array('class'=>"cantidad form-control",'label'=>false,'type'=>'text','style'=>'text-align: left;','data-bv-notempty'=>'true','data-bind'=>'value: cantidad')); ?>
						</td>
						<td class="col-md-1" style="padding:0px;">
						...
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('largo.',array('class'=>"largo form-control",'label'=>false,'type'=>'text','data-bv-notempty'=>'true','data-bind'=>'value: largo')); ?>
						</td>
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('ancho.',array('class'=>"ancho form-control",'label'=>false,'type'=>'text','data-bv-notempty'=>'true','data-bind'=>'value: ancho')); ?>
						</td>
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('alto.',array('class'=>"alto form-control",'label'=>false,'type'=>'text','data-bv-notempty'=>'true','data-bind'=>'value: alto')); ?>
						</td>
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('peso.',array('class'=>"peso form-control",'label'=>false,'type'=>'text','data-bv-notempty'=>'true','data-bind'=>'value: peso')); ?>
						</td>
						<td class="col-md-1" style="padding:0px;">
						...
						<td class="col-md-1" style="padding:0px;">
							<?php echo $this->Form->input('kiloAd.',array('class'=>'kiloAd','label'=>false,'type'=>'text','readonly'=>'readonly','data-bind'=>'value: kiloAd')); ?>
						</td>
...
<script>
	$("#btn-submit").click(function(){
		if(ajaxCall != undefined){
			...
			if(auxi < 0){
				...
				itsclicked = true;
				$("#VentasCreditoEditarForm").submit();
			}
		}
	});
	...
	function calcularTotal(){
		...
		op          = costoFlete+costoAdic+costoSeguro+costoDevol-(costoFlete*descFlete/100)-(costoAdic*descKilo/100);

		$("#VentasCreditoValorTotal").val(op.toFixed(0));
		var op2 = op.formatMoney(0,',','.');
		$("#costoTotal").text(op2);
	...
	var clienteId              = <?php echo json_encode($usuario_actual['cliente_id']); ?>;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$.each( clientes, function( key, value ) {
			if(clienteId == value.Cliente.id){
				if(value.Cliente.activo == "No"){
					...
					$("#VentasCreditoDocumentoClien").val(value.Cliente.documento);
					$("#VentasCreditoNombreClien").val(value.Cliente.listNombre);
	...
	var destinoId  = <?php echo $this->data['VentasCredito']['destino']; ?>;
	var origenId   = <?php echo $this->data['VentasCredito']['origen']; ?>;
	var empaquesKO = <?php echo $this->data['VentasCredito']['empaque_info']; ?>;
$(document).ready(function(){
	$.ajax({
		...
		success: function(response) {
			...
			$.each($(".alto"),function(key,value){
				var padreAux = $(this).parent().parent().parent();
				$(this).val(empaquesKO[key].alto);
				...
				padreAux.find('.pesoUni').val(empaquesKO[key].pesoUni);
				padreAux.find('.pesoVol').val(empaquesKO[key].pesoVol);
			...
			$(".peso").trigger("change");
			$("#VentasCreditoDeclarado").trigger("blur");
			$("#VentasCreditoFirmado").trigger("change");
			$.each($(".empaques"), function( key, value ) {
		    	$(value).chosen({
					no_results_text           : 'No se encuentra el empaque.',
					width                     : "95%",
	...
	$('#VentasCreditoOrigen').val(origenId);
	$('#VentasCreditoDestino').val(destinoId);
	$('#VentasCreditoOrigen').trigger('chosen:updated');
	$('#VentasCreditoDestino').trigger('chosen:updated');
	...
	$("#btn-limpiar").click(function(){
		...
		viewModel.addUser();
		$("#div-remitente").hide();
		$("#VentasCreditoDevolverFirmado").val(0);
		...
		if($(this).val() == "Si"){
			...
			$.each( ajaxCall.Tarifa, function( key, value ) {
				if(4 == value.Tarifa.empaque_id){
					...
					$("#VentasCreditoDevolverFirmado").val(costoDevol);
				}
			});
			if(!existeDevol){
