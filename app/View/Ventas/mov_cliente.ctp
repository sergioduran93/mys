...
<div class="row" style="width:90%; margin-left:5%;">   
	<br>
	<div><h3><center>MOVILIZACIÓN POR CLIENTE</center></h3></div>
    <fieldset>
...
$(document).ready(function(){
	...
	$("#enviar").click(function(){
		...
		$.ajax({
			type: "POST",
			cache: false,
			url: url+"/enviarMovCliente",
			data: $("#VentaMovClienteForm").serializeArray(),
	...
	oTable = $('#tabla_id').dataTable( {
		...
		"sAjaxSource": webroot+'sources/mov_cliente.txt',
