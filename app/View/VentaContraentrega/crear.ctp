...
<div class="row" style="width:90%; margin-left:5%;">
	<br>	
	<?php echo $this->Form->create('VentaContraentrega',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
		<div><h3 class="h3-red"><center>VENTAS DE CONTRAENTREGA</center></h3></div>
...
<script>
	...
	function calcularTotal(){
		...
		$("#VentaContraentregaKiloNego").val(sumaKiloNego.toFixed(0));
		$("#VentaContraentregaKiloAdic").val(pesoKiloAd.toFixed(0));
		$("#VentaContraentregaValorKiloAdic").val(costoAdic.toFixed(0));
		$("#VentaContraentregaValorSeguro").val(costoSeguro);
		$("#VentaContraentregaValorDevolucion").val(costoDevol);
		$("#VentaContraentregaDescFlete").val((costoFlete*descFlete/100).toFixed(0));
		$("#VentaContraentregaDescKilo").val((costoAdic*descKilo/100).toFixed(0));
		...
		op = round100(op);
		$("#VentaContraentregaValorTotal").val(op.toFixed(0));
		op = op.formatMoney(0,',','.');
		$("#costoTotal").text(op);
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$(function() {
	$("#VentaContraentregaDocumentoClien").autocomplete({
			...
			$.each( clientes, function( key, value ) {
				if(ui.item.value == value.Cliente.documento){
					if(value.Cliente.activo == "No"){
						$("#VentaContraentregaDocumentoClien").val("");
						$("#VentaContraentregaCliente").val("");
						$("#VentaContraentregaNombreClien").val("");
						$("#VentaContraentregaDireccionClien").val("");
						$("#VentaContraentregaTelefonoClien").val("");
						$("#VentaContraentregaTelefono2Clien").val("");
						$("#VentaContraentregaEmailClien").val("");
						$("#VentaContraentregaFaxClien").val("");
						...
						$("#VentaContraentregaCliente").val(value.Cliente.id);
						$("#VentaContraentregaNombreClien").val(value.Cliente.listNombre);
						$("#VentaContraentregaDireccionClien").val(value.Cliente.direccion);
						$("#VentaContraentregaTelefonoClien").val(value.Cliente.telefono);
						$("#VentaContraentregaTelefono2Clien").val(value.Cliente.telefono2);
						$("#VentaContraentregaEmailClien").val(value.Cliente.email);
						$("#VentaContraentregaFaxClien").val(value.Cliente.fax);
						...
						$("#VentaContraentregaDocumentoRemi").autocomplete('option', 'source', remitentIdentificacion);
						$("#VentaContraentregaNombreRemi").autocomplete('option', 'source', remitentNombre);
					}
					$("#VentaContraentregaDestino").val("");
					$("#VentaContraentregaOrigen").val("");
					$("#VentaContraentregaOrigen").trigger("chosen:updated");
					$("#VentaContraentregaDestino").trigger("chosen:updated");
				}
			});
		}
	});
	$("#VentaContraentregaNombreClien").autocomplete({
			...
			$.each( clientes, function( key, value ) {
				if(ui.item.value == value.Cliente.listNombre){
					if(value.Cliente.activo == "No"){
						...
						clienteId = value.Cliente.id;
						$("#VentaContraentregaCliente").val(value.Cliente.id);
						$("#VentaContraentregaDocumentoClien").val(value.Cliente.documento);
						$("#VentaContraentregaDireccionClien").val(value.Cliente.direccion);
						$("#VentaContraentregaTelefonoClien").val(value.Cliente.telefono);
						$("#VentaContraentregaTelefono2Clien").val(value.Cliente.telefono2);
						$("#VentaContraentregaEmailClien").val(value.Cliente.email);
	...
	$("#VentaContraentregaDocumentoRemi").autocomplete({
		...
		select: function( event, ui ) {
			$.each( remitentes, function( key, value ) {
				if(ui.item.value == value.Remitente.documento){
					...
					$("#VentaContraentregaRemitente").val(value.Remitente.id);
					$("#VentaContraentregaNombreRemi").val(value.Remitente.nombre);
					$("#VentaContraentregaDireccionRemi").val(value.Remitente.direccion);
					$("#VentaContraentregaTelefonoRemi").val(value.Remitente.telefono);
					$("#VentaContraentregaCelularRemi").val(value.Remitente.celular);
					$("#VentaContraentregaEmailRemi").val(value.Remitente.email);
					var contactos = JSON.parse(value.Remitente.contacto);
					var contactosArray = new Array();
					$.each(contactos, function(key2, value2) {
						contactosArray[key2] = value2.nombre;
					});
					$("#VentaContraentregaContacto").autocomplete('option', 'source', contactosArray);
				}
			});
		}
	});
	$("#VentaContraentregaNombreRemi").autocomplete({
		...
		select: function( event, ui ) {
			$.each( remitentes, function( key, value ) {
				if(ui.item.value == value.Remitente.nombre){
					remitenteId = value.Remitente.id;
					$("#VentaContraentregaRemitente").val(value.Remitente.id);
					$("#VentaContraentregaDocumentoRemi").val(value.Remitente.documento);
					$("#VentaContraentregaDireccionRemi").val(value.Remitente.direccion);
					$("#VentaContraentregaTelefonoRemi").val(value.Remitente.telefono);
					$("#VentaContraentregaCelularRemi").val(value.Remitente.celular);
					$("#VentaContraentregaEmailRemi").val(value.Remitente.email);
	...
	$("#VentaContraentregaDocumentoDest").autocomplete({
		...
		select: function( event, ui ) {
			$.each( destinatarios, function( key, value ) {
				if(ui.item.value == value.Destinatario.documento){
					...
					$("#VentaContraentregaDestinatario").val(value.Destinatario.id);
					$("#VentaContraentregaNombreDest").val(value.Destinatario.listNombre);
					$("#VentaContraentregaDireccionDest").val(value.Destinatario.direccion);
					$("#VentaContraentregaTelefonoDest").val(value.Destinatario.telefono);
					$("#VentaContraentregaTelefono2Dest").val(value.Destinatario.telefono2);
					$("#VentaContraentregaEmailDest").val(value.Destinatario.email);
					$("#VentaContraentregaFaxDest").val(value.Destinatario.fax);
				}
			});
		}
	});
	$("#VentaContraentregaNombreDest").autocomplete({
		...
		select: function( event, ui ) {
			$.each( destinatarios, function( key, value ) {
				if(ui.item.value == value.Destinatario.listNombre){
					destinatarioId = value.Destinatario.id;
					$("#VentaContraentregaDestinatario").val(value.Destinatario.id);
					$("#VentaContraentregaDocumentoDest").val(value.Destinatario.documento);
					$("#VentaContraentregaDireccionDest").val(value.Destinatario.direccion);
					$("#VentaContraentregaTelefonoDest").val(value.Destinatario.telefono);
					$("#VentaContraentregaTelefono2Dest").val(value.Destinatario.telefono2);
					$("#VentaContraentregaEmailDest").val(value.Destinatario.email);
	...
	$("#VentaContraentregaContacto").autocomplete({
...
$(document).ready(function(){
	$("#VentaContraentregaOrigen").val(ciudad);
	$("#VentaContraentregaOrigen").trigger("chosen:updated");
		...
		if(e.which == 13) {
			...
			$.each( clientes, function( key, value ) {
				if(value.Cliente.id == cl){
					$("#VentaContraentregaDocumentoClien").val(clientesIdentificacion[key]);
					$("#VentaContraentregaDocumentoClien").trigger("change");
					$("#VentaContraentregaNombreClien").trigger("change");
					$("#VentaContraentregaDireccionClien").trigger("change");
					$("#VentaContraentregaTelefonoClien").trigger("change");
				}
			});
			$("#VentaContraentregaDocumento1").focus();
			$("#VentaContraentregaOrigen").val(ciudad);
			$("#VentaContraentregaOrigen").trigger("chosen:updated");
		}
	});
	...
	$("#VentaContraentregaRecaudador").chosen({
	...
	viewModel.addUser();
	$("#VentaContraentregaFecha").datepicker({minDate: 0});

	$("#VentaContraentregaOtroRemi").change(function(){
		if($(this).is(':checked')){
			$("#div-remitente").show();
		} else {
			$("#div-remitente").hide();
	...
	$("#btn-limpiar").click(function(){
		...
		viewModel.addUser();
		$("#div-remitente").hide();
		$("#VentaContraentregaDevolverFirmado").val(0);
		$("#VentaContraentregaTipo").val(0);
		$("#kiloAdSpan").text("0");
		$("#VentaContraentregaDeclarado").val("");
		$("#VentaContraentregaFirmado").val("No");
		$("#VentaContraentregaDestino").val("");
		$("#VentaContraentregaOrigen").val("");
		$("#VentaContraentregaDocumentoRemi").val("");
		$("#VentaContraentregaTelefono").val("");
		$("#VentaContraentregaTelefono").trigger("chosen:updated");
		$("#VentaContraentregaOrigen").trigger("chosen:updated");
		$("#VentaContraentregaDestino").trigger("chosen:updated");
		clienteId      = 1;
		remitenteId    = 0;
...
/*
	$("#VentaContraentregaDeclarado").number( true, 0 );
*/
	$("#VentaContraentregaDeclarado").keyup(function(){
		var strNum = $(this).val();
	...
	$("#VentaContraentregaDeclarado").blur(function(){
		seguro = 0;
	...
	$("#VentaContraentregaFirmado").change(function(){
		if($(this).val() == "Si"){
			...
			$.each( ajaxCall.Tarifa, function( key, value ) {
				if(4 == value.Tarifa.empaque_id){
					...
					$("#VentaContraentregaDevolverFirmado").val(costoDevol);
				}
			});
			if(!existeDevol){
	...
	$("#VentaContraentregaOrigen").chosen({
	...
	$("#VentaContraentregaDestino").chosen({
		no_results_text           : 'No se encuentra el destino.',
		width                     : "95%",
		allow_single_deselect     : true, search_contains           : true,
		disable_search_threshold  : 10,
	...
	$("#VentaContraentregaDocumentoClien").change(function(){
		var flag = true;
		...
		if(flag){
			if(confirm("El cliente NO existe, ¿Desea registrarlo?")){
				var docAct  = $("#VentaContraentregaDocumentoClien").val();
				var nomAct  = $("#VentaContraentregaNombreClien").val();
				var nomAct2 = "";
				if(docAct == ""){
					docAct = "*";
				}
				...
				$.fancybox.open({
					...
					beforeClose: function(){
						...
						$("#VentaContraentregaDocumentoClien").val(arrayInfo[0]);
						$("#VentaContraentregaNombreClien").val(arrayInfo[1]);
						$("#VentaContraentregaDireccionClien").val(arrayInfo[2]);
						$("#VentaContraentregaTelefonoClien").val(arrayInfo[3]);
						$("#VentaContraentregaTelefono2Clien").val(arrayInfo[4]);
						$("#VentaContraentregaEmailClien").val(arrayInfo[5]);
						$("#VentaContraentregaFaxClien").val(arrayInfo[6]);
						remitentIdentificacion = new Array();
						remitentNombre         = new Array();
						if(arrayInfo[7] != null){
							var i = 0;
	...
	$("#VentaContraentregaNombreClien").change(function(){
		var flag = true;
		var docuCli = $(this).val();
		$.each( clientes, function( key, value ) {
	...
	$("#VentaContraentregaNombreDest").change(function(){
		var flag = true;
		...
		if(flag){
			if(confirm("El destinatario NO existe, ¿Desea registrarlo?")){
				var docAct  = $("#VentaContraentregaDocumentoDest").val();
				var nomAct  = $("#VentaContraentregaNombreDest").val();
				var nomAct2 = "";
				if(docAct == ""){
					docAct = "/*";
				} else {
				...
				$.fancybox.open({
					...
					beforeClose: function(){
						...
						arrayInfo = JSON.parse(retorno);
						$("#VentaContraentregaDocumentoDest").val(arrayInfo[0]);
						$("#VentaContraentregaNombreDest").val(arrayInfo[1]);
						$("#VentaContraentregaDireccionDest").val(arrayInfo[2]);
						$("#VentaContraentregaTelefonoDest").val(arrayInfo[3]);
						$("#VentaContraentregaTelefono2Dest").val(arrayInfo[4]);
						$("#VentaContraentregaEmailDest").val(arrayInfo[5]);
						$("#VentaContraentregaFaxDest").val(arrayInfo[6]);
					}
				});
			}
		}
	});
	$("#VentaContraentregaDocumentoDest").change(function(){
		var flag = true;
		var docuDest = $(this).val();
		$.each( destinatarios, function( key, value ) {
	...
	/*
	$('#VentaContraentregaDocumentoClien').JCombo({
		'parentId': 'VentaContraentregaDocumentoClien',
		'nodeId'  : 'VentaContraentregaDocumentoRemi',
		'data'    : selectDep
	});*/
...
location.reload(true);
	...
	$("#VentaContraentregaOrigen").change(function(){
		$("#VentaContraentregaDestino").val("");
		$("#VentaContraentregaDestino").trigger("chosen:updated");
	});
	$("#VentaContraentregaDestino").change(function(){
		if($("#VentaContraentregaOrigen").val() == ""){
			...
			if($(this).val() != ""){
				...
				$("#VentaContraentregaDocumentoDest").autocomplete('option', 'source', destinatIdentificacion);
				$("#VentaContraentregaNombreDest").autocomplete('option', 'source', destinatNombre);
				$("#kiloAdSpan").val("");
				$("#VentaContraentregaDestinatario").val("");
				$("#VentaContraentregaNombreDest").val("");
				$("#VentaContraentregaDocumentoDest").val("");
				$("#VentaContraentregaDireccionDest").val("");
				$("#VentaContraentregaTelefonoDest").val("");
				$("#VentaContraentregaTelefono2Dest").val("");
				$("#VentaContraentregaEmailDest").val("");
				$("#VentaContraentregaFaxDest").val("");
				origenId  = $("#VentaContraentregaOrigen").val();
				destinoId = $("#VentaContraentregaDestino").val();
				$("#VentaContraentregaDeclarado").val("");
				...
				$("#VentaContraentregaFirmado").val("No");
				calcularTotal();
				var clienteDocumActual = $("#VentaContraentregaDocumentoClien").val();
				var flag = true;
				$.each( clientes, function( key, value ) {
				...
				$.ajax({
					type: 'json',
					url: fullpath+"VentaContraentrega/getTarifa/"+clienteId+"/"+origenId+"/"+destinoId,
					...
					success: function(response) {
						...
						ajaxCall = response;
						$("#VentaContraentregaRecaudador").empty();
						$.each(ajaxCall.Recaudadores, function(key, value) {
							$("#VentaContraentregaRecaudador").append($("<option></option>").attr("value", key).text(value));
						});
						$("#VentaContraentregaRecaudador").trigger("chosen:updated");
