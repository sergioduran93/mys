	...
	<?php echo $this->Form->create('Recibo',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
	    ...
	    <div class="form-group col-md-12">
	    	...
	    	<div class="col-md-3"><?php echo $this->Form->input('negociador',array('label'=>'Conductor CC: ','class'=>'provisional','type'=>'text','placeholder'=>'Seleccione')); ?></div>
       		<div class="col-md-3"><?php echo $this->Form->input('negociador_nom',array('label'=>'Conductor Nombre: ','class'=>'provisional','type'=>'text','placeholder'=>'Seleccione')); ?></div>
	    	<div class="col-md-3"><?php echo $this->Form->input('documento',array('label'=>'Placa: ','class'=>'provisional','type'=>'text','placeholder'=>'Seleccione')); ?></div>
		</div>
	    <div class="form-group col-md-12">
