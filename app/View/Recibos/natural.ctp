...
<div class="row" style="width:90%; margin-left:5%;">
	...
	<?php echo $this->Form->create('Recibo',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
		...
		<?php echo $this->Form->input('tipo',array('type'=>'hidden','default'=>'Natural')); ?>
	    <div class="form-group col-md-12">
			<div class="col-md-6"><?php echo $this->Form->input('guia_id',array('label'=>'Guia: ','type'=>'select','options'=>$ventasL,'empty'=>'')); ?></div>
			<div class="col-md-3"><?php echo $this->Form->input('barras',array('label'=>'Barras: ','type'=>'text')); ?></div>
			<div class="col-md-3"><?php echo $this->Form->input('fecha',array('label'=>'Fecha: ','type'=>'text','readonly'=>'readonly','default'=>$fecha)); ?></div>
		</div>
	    <div class="form-group col-md-12">
	    	<div class="col-md-3"><?php echo $this->Form->input('destino',array('label'=>'Destino: ','class'=>'provisional','type'=>'select','options'=>$destinos,'empty'=>"")); ?></div>
	    	<div class="col-md-3"><?php echo $this->Form->input('negociador',array('label'=>'Conductor CC: ','class'=>'provisional','type'=>'text','placeholder'=>'Seleccione')); ?></div>
       		<div class="col-md-3"><?php echo $this->Form->input('negociador_nom',array('label'=>'Conductor Nom.: ','class'=>'provisional','type'=>'text','placeholder'=>'Seleccione')); ?></div>
	    	<div class="col-md-3"><?php echo $this->Form->input('documento',array('label'=>'Placa: ','class'=>'provisional','type'=>'text')); ?></div>
		</div>
	    <div class="form-group col-md-12">
		...
		<div class="form-group col-md-12">
	    	<div class="col-md-12"><?php echo $this->Form->input('obs',array('label'=>'Observaciones: ','placeholder'=>'Tel Conductor, Nro Placa, Etc...')); ?></div>
		</div>
...
$(function() {
	...
	$("#ReciboNegociador").autocomplete({
		source: condDoc,
		select: function( event, ui ) {
			$.each( conductores, function( key, value ) {
				if(ui.item.value == value.Conductor.identificacion){
					$("#ReciboNegociadorNom").val(value.Conductor.listNombre);
				}
			});
		}
	});
	$("#ReciboNegociadorNom").autocomplete({
		source: condNom,
		select: function( event, ui ) {
			$.each( conductores, function( key, value ) {
				if(ui.item.value == value.Conductor.listNombre){
					$("#ReciboNegociador").val(value.Conductor.identificacion);
				}
			});
		}
	});
