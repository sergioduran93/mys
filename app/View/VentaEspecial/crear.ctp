...
<div class="row" style="width:90%; margin-left:5%;">
	<br>	
	<?php echo $this->Form->create('VentaEspecial',array('class'=>'form-inline','onsubmit' => 'return itsclicked;'));?>
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$("#VentaEspecialDocumentoClien").change(function(){
		var clienteSelec = $("#VentaEspecialDocumentoClien").val();
		$.each( clientes, function( key, value ) {
			if(clienteSelec == value.Cliente.id){
				if(value.Cliente.activo == "No"){
					$("#VentaEspecialDocumentoClien").val("");
					$("#VentaEspecialCliente").val("");
					$("#VentaEspecialNombreClien").val("");
					$("#VentaEspecialDireccionClien").val("");
					$("#VentaEspecialTelefonoClien").val("");
					$("#VentaEspecialTelefono2Clien").val("");
					$("#VentaEspecialEmailClien").val("");
					$("#VentaEspecialFaxClien").val("");
					...
					$("#VentaEspecialCliente").val(value.Cliente.id);
					$("#VentaEspecialNombreClien").val(clienteSelec);
					$("#VentaEspecialDireccionClien").val(value.Cliente.direccion);
					$("#VentaEspecialTelefonoClien").val(value.Cliente.telefono);
					$("#VentaEspecialTelefono2Clien").val(value.Cliente.telefono2);
					$("#VentaEspecialEmailClien").val(value.Cliente.email);
					$("#VentaEspecialFaxClien").val(value.Cliente.fax);
					...
					$("#VentaEspecialDocumentoRemi").empty();
					$("#VentaEspecialNombreRemi").empty();
					$.each(remitentIdentificacion, function(key, value) {
						$("#VentaEspecialDocumentoRemi").append($("<option></option>").attr("value", value).text(value));
					});
					$.each(remitentNombre, function(key, value) {
						$("#VentaEspecialNombreRemi").append($("<option></option>").attr("value", value).text(value));
					});
				}
				$("#VentaEspecialDestino").val("");
				$("#VentaEspecialOrigen").val("");
				$("#VentaEspecialOrigen").trigger("chosen:updated");
				$("#VentaEspecialDestino").trigger("chosen:updated");
				$("#VentaEspecialDocumentoRemi").trigger("chosen:updated");
				$("#VentaEspecialNombreRemi").trigger("chosen:updated");
				$("#VentaEspecialNombreClien").trigger("chosen:updated");
			}
		});
	});
	$("#VentaEspecialNombreClien").change(function(){
		var clienteSelec = $("#VentaEspecialNombreClien").val();
		$.each( clientes, function( key, value ) {
			if(clienteSelec == value.Cliente.id){
				if(value.Cliente.activo == "No"){
					$("#VentaEspecialDocumentoClien").val("");
					...
					clienteId = value.Cliente.id;
					$("#VentaEspecialCliente").val(value.Cliente.id);
					$("#VentaEspecialDocumentoClien").val(clienteSelec);
					$("#VentaEspecialDireccionClien").val(value.Cliente.direccion);
					$("#VentaEspecialTelefonoClien").val(value.Cliente.telefono);
					$("#VentaEspecialTelefono2Clien").val(value.Cliente.telefono2);
					$("#VentaEspecialEmailClien").val(value.Cliente.email);
				...
				$("#VentaEspecialDocumentoRemi").trigger("chosen:updated");
				$("#VentaEspecialNombreRemi").trigger("chosen:updated");
				$("#VentaEspecialDocumentoClien").trigger("chosen:updated");
			}
		});
	});

	$("#VentaEspecialDocumentoRemi").change(function(){
		var remitenSelec = $("#VentaEspecialDocumentoRemi").val();
		$.each( remitentes, function( key, value ) {
			if(remitenSelec == value.Remitente.documento){
				remitenteId = value.Remitente.id;
				$("#VentaEspecialRemitente").val(value.Remitente.id);
				$("#VentaEspecialNombreRemi").val(value.Remitente.nombre);
				$("#VentaEspecialDireccionRemi").val(value.Remitente.direccion);
				$("#VentaEspecialTelefonoRemi").val(value.Remitente.telefono);
				$("#VentaEspecialCelularRemi").val(value.Remitente.celular);
				$("#VentaEspecialEmailRemi").val(value.Remitente.email);
				$("#VentaEspecialNombreRemi").trigger("chosen:updated");
				...
				$("#VentaEspecialContacto").autocomplete('option', 'source', contactosArray);
			}
		});
	});
	$("#VentaEspecialNombreRemi").change(function(){
		var remitenSelec = $("#VentaEspecialNombreRemi").val();
		$.each( remitentes, function( key, value ) {
			if(remitenSelec == value.Remitente.nombre){
				remitenteId = value.Remitente.id;
				$("#VentaEspecialRemitente").val(value.Remitente.id);
				$("#VentaEspecialDocumentoRemi").val(value.Remitente.documento);
				$("#VentaEspecialDireccionRemi").val(value.Remitente.direccion);
				$("#VentaEspecialTelefonoRemi").val(value.Remitente.telefono);
				$("#VentaEspecialCelularRemi").val(value.Remitente.celular);
				$("#VentaEspecialEmailRemi").val(value.Remitente.email);
	...
	$("#VentaEspecialDocumentoDest").autocomplete({
		...
		select: function( event, ui ) {
			$.each( destinatarios, function( key, value ) {
				if(ui.item.value == value.Destinatario.documento){
					...
					$("#VentaEspecialDestinatario").val(value.Destinatario.id);
					$("#VentaEspecialNombreDest").val(value.Destinatario.listNombre);
					$("#VentaEspecialDireccionDest").val(value.Destinatario.direccion);
					$("#VentaEspecialTelefonoDest").val(value.Destinatario.telefono);
					$("#VentaEspecialTelefono2Dest").val(value.Destinatario.telefono2);
					$("#VentaEspecialEmailDest").val(value.Destinatario.email);
					$("#VentaEspecialFaxDest").val(value.Destinatario.fax);
				}
			});
		}
	});
	$("#VentaEspecialNombreDest").autocomplete({
		...
		select: function( event, ui ) {
			$.each( destinatarios, function( key, value ) {
				if(ui.item.value == value.Destinatario.listNombre){
					destinatarioId = value.Destinatario.id;
					$("#VentaEspecialDestinatario").val(value.Destinatario.id);
					$("#VentaEspecialDocumentoDest").val(value.Destinatario.documento);
					$("#VentaEspecialDireccionDest").val(value.Destinatario.direccion);
					$("#VentaEspecialTelefonoDest").val(value.Destinatario.telefono);
					$("#VentaEspecialTelefono2Dest").val(value.Destinatario.telefono2);
					$("#VentaEspecialEmailDest").val(value.Destinatario.email);
	...
	$("#VentaEspecialContacto").autocomplete({
		source: contactosArray
	});
	$("#div-remitente").hide();
	var reempaqueAjax;
$(document).ready(function(){
	$("#VentaEspecialOrigen").val(ciudad);
	$("#VentaEspecialOrigen").trigger("chosen:updated");
	...
	$("#VentaEspecialTipo").autocomplete({
		source: tipoGuia,
		change: function( event, ui ){
			var tipoSel = $(this).val();
			var ref1 = $("#VentaEspecialDocumento1").val();

			if(ref1 != "" && (tipoSel == "Reempaque" || tipoSel == "Tras. Nacional")){
				$.fancybox.showLoading();
				$.fancybox.helpers.overlay.open();
				if(tipoSel == "Reempaque"){
					$.ajax({
						type: 'json',
						url: fullpath+"ventasespecial/getReempaque/"+ref1,
						beforeSend: function(xhr) {
							xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
						},
						success: function(response) {
							response      = JSON.parse(response);
							reempaqueAjax = response;
							$("#VentaEspecialDocumentoClien").val(2);
							$("#VentaEspecialDocumentoClien").trigger("chosen:updated");
							$("#VentaEspecialDocumentoClien").trigger('change');

							$("#VentaEspecialOrigen").val(response.origen);
							$("#VentaEspecialDestino").val(response.destino);
							$("#VentaEspecialOrigen").trigger("chosen:updated");
							$("#VentaEspecialDestino").trigger("chosen:updated");
							$("#VentaEspecialDestino").trigger('change');

							$.each( destinatarios, function( key, value ) {
								if(value.Destinatario.id == response.destinatario){
									$("#VentaEspecialDocumentoDest").val(value.Destinatario.documento);
									$("#VentaEspecialNombreDest").val(value.Destinatario.listNombre);
									$("#VentaEspecialDireccionDest").val(value.Destinatario.direccion);
									$("#VentaEspecialTelefonoDest").val(value.Destinatario.telefono);
									$("#VentaEspecialTelefono2Dest").val(value.Destinatario.celular);
									$("#VentaEspecialEmailDest").val(value.Destinatario.email);
									$("#VentaEspecialFaxDest").val(value.Destinatario.fax);
								}
							});
							$("#VentaEspecialDeclarado").val("0");
							$("#VentaEspecialContenido").val("REEMPAQUE");
							$("#VentaEspecialEmpaques").trigger('chosen:activate');
							$("#VentaEspecialEmpaques").trigger('chosen:open');
						},
						error: function(e) {
					...
					$.ajax({
						type: 'json',
						url: fullpath+"ventasespecial/getNacional/"+ref1,
						beforeSend: function(xhr) {
							xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
						},
						success: function(response) {
			...
			if(ref1 != "" && tipoSel.substring(0,13) == decodeURI("Nota Devoluci")){
				$.fancybox.showLoading();
				$.fancybox.helpers.overlay.open();
				$.ajax({
					type: 'json',
					url: fullpath+"ventasespecial/getDevolucion/"+ref1,
					beforeSend: function(xhr) {
						xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
					},
					success: function(response) {
						...
						$.each( clientes, function( key, value ) {
							if(value.Cliente.id == response.destinatario){
								$("#VentaEspecialDocumentoDest").val(value.Cliente.documento);
								$("#VentaEspecialNombreDest").val(value.Cliente.listNombre);
								$("#VentaEspecialDireccionDest").val(value.Cliente.direccion);
								$("#VentaEspecialTelefonoDest").val(value.Cliente.telefono);
								$("#VentaEspecialTelefono2Dest").val(value.Cliente.celular);
								$("#VentaEspecialEmailDest").val(value.Cliente.email);
								$("#VentaEspecialFaxDest").val(value.Cliente.fax);
							}
						});
						$(".empaques").val(4);
						$(".empaques").trigger("chosen:updated");

						$(".descripcion").val(response.guias);
						...
						$("#VentaEspecialDeclarado").val("0");
						$("#VentaEspecialContenido").val("NOTA DE DEVOLUCIÓN");
						$("#VentaEspecialEmpaques").trigger('chosen:activate');
						$("#VentaEspecialEmpaques").trigger('chosen:open');
					},
					error: function(e) {
	...
	$("#selbarra").keypress(function(e){
		if(e.which == 13) {
			...
			$("#VentaEspecialDocumentoClien").val(cl);
			$("#VentaEspecialDocumentoClien").trigger('chosen:updated');
			$("#VentaEspecialDocumentoClien").trigger('change');
			//$("#VentaEspecialDestino").trigger('chosen:activate');
			$("#VentaEspecialDocumento1").focus();
			$("#VentaEspecialOrigen").val(ciudad);
			$("#VentaEspecialOrigen").trigger("chosen:updated");
		}
	});
	...
	viewModel.addUser();
	$("#VentaEspecialFecha").datepicker({minDate: 0});

	$("#VentaEspecialOtroRemi").change(function(){
		if($(this).is(':checked')){
			$("#div-remitente").show();
		} else {
			$("#div-remitente").hide();
	...
	$("#btn-limpiar").click(function(){
		...
		viewModel.addUser();
		$("#div-remitente").hide();
		$("#VentaEspecialDevolverFirmado").val(0);
		$("#VentaEspecialTipo").val(0);
		$("#kiloAdSpan").text("0");
		$("#VentaEspecialDeclarado").val("");
		$("#VentaEspecialFirmado").val("No");
		$("#VentaEspecialCancelada").val("No");
		$("#VentaEspecialDestino").val("");
		$("#VentaEspecialOrigen").val("");
		$("#VentaEspecialDocumentoRemi").val("");
		$("#VentaEspecialTelefono").val("");
		$("#VentaEspecialTelefono").trigger("chosen:updated");
		$("#VentaEspecialOrigen").trigger("chosen:updated");
		$("#VentaEspecialDestino").trigger("chosen:updated");
		clienteId      = 1;
		remitenteId    = 0;
...
/*
	$("#VentaEspecialDeclarado").number( true, 0 );
*/
	$("#VentaEspecialDeclarado").keyup(function(){
		var strNum = $(this).val();
	...
	$("#VentaEspecialDeclarado").blur(function(){
		seguro = 0;
	});

	$("#VentaEspecialOrigen").chosen({
	...
	$("#VentaEspecialDocumentoClien").chosen({
	...
	$("#VentaEspecialNombreClien").chosen({
		no_results_text           : 'No se encuentra el cliente.',
		width                     : "95%",
		allow_single_deselect     : true, 
		search_contains           : true,
	...
	$("#VentaEspecialDocumentoRemi").chosen({
	...
	$("#VentaEspecialNombreRemi").chosen({
		no_results_text           : 'No se encuentra el remitente.',
		width                     : "95%",
		allow_single_deselect     : true, 
		search_contains           : true,
	...
	$("#VentaEspecialNombreDest").change(function(){
		var flag = true;
		...
		if(flag){
			if(confirm("El destinatario NO existe, ¿Desea registrarlo?")){
				var docAct  = $("#VentaEspecialDocumentoDest").val();
				var nomAct  = $("#VentaEspecialNombreDest").val();
				var nomAct2 = "";
				if(docAct == ""){
					docAct = "/*";
				} else {
				...
				$.fancybox.open({
					...
					beforeClose: function(){
						...
						$("#VentaEspecialDocumentoDest").val(arrayInfo[0]);
						$("#VentaEspecialNombreDest").val(arrayInfo[1]);
						$("#VentaEspecialDireccionDest").val(arrayInfo[2]);
						$("#VentaEspecialTelefonoDest").val(arrayInfo[3]);
						$("#VentaEspecialTelefono2Dest").val(arrayInfo[4]);
						$("#VentaEspecialEmailDest").val(arrayInfo[5]);
						$("#VentaEspecialFaxDest").val(arrayInfo[6]);
					}
				});
			}
		}
	});
	$("#VentaEspecialDocumentoDest").change(function(){
		var flag = true;
		var docuDest = $(this).val();
		$.each( destinatarios, function( key, value ) {
	...
	$("#VentaEspecialOrigen").change(function(){
		$("#VentaEspecialDestino").val("");
		$("#VentaEspecialDestino").trigger("chosen:updated");
	});
	$("#VentaEspecialDestino").change(function(){
		if($("#VentaEspecialOrigen").val() == ""){
			...
			if($(this).val() != ""){
				...
				$("#VentaEspecialDocumentoDest").autocomplete('option', 'source', destinatIdentificacion);
				$("#VentaEspecialNombreDest").autocomplete('option', 'source', destinatNombre);
				$("#kiloAdSpan").val("");
				$("#VentaEspecialDestinatario").val("");
				$("#VentaEspecialNombreDest").val("");
				$("#VentaEspecialDocumentoDest").val("");
				$("#VentaEspecialDireccionDest").val("");
				$("#VentaEspecialTelefonoDest").val("");
				$("#VentaEspecialTelefono2Dest").val("");
				$("#VentaEspecialEmailDest").val("");
				$("#VentaEspecialFaxDest").val("");
				origenId  = $("#VentaEspecialOrigen").val();
				destinoId = $("#VentaEspecialDestino").val();
				$("#VentaEspecialDeclarado").val("");
				...
				$("#VentaEspecialFirmado").val("No");
				calcularTotal();
				var clienteDocumActual = $("#VentaEspecialDocumentoClien").val();
				var flag = true;
				$.each( clientes, function( key, value ) {
				...
				$.ajax({
					type: 'json',
					url: fullpath+"VentaEspecial/getTarifa/"+clienteId+"/"+origenId+"/"+destinoId,
					beforeSend: function(xhr) {
						xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
					},
					success: function(response) {
