...
for ($i=0; $i < $n; $i++) { 
	...
	if($otro_remi){
		...
		$pdf->SetXY(18,51);
		$pdf->Cell(50, 1, $remitente, 0, 1, 'C', 0, '', 1);
		$pdf->SetXY(21,56);
		$pdf->Cell(50, 1, $direccionR, 0, 1, 'L', 0, '', 1);
		$pdf->SetXY(122,51);
		$pdf->Cell(50, 1, $nitR, 0, 1, 'L', 0, '', 1);
		$pdf->SetXY(122,56);
		$pdf->Cell(50, 1, $telefonoR, 0, 1, 'L', 0, '', 1);
		$pdf->SetXY(21,61);
		$pdf->Cell(50, 1, $contactoR, 0, 1, 'L', 0, '', 1);
		$pdf->SetXY(122,61);
		$pdf->Cell(50, 1, $contactoTelR, 0, 1, 'L', 0, '', 1);
		$pdf->SetFont('Times','B',11);
	} else {
		$remi = 0;
	}
	...
	$pdf->SetXY(26,41);
	$pdf->Cell(80, 1, $direccionC, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(26,46);
	...
	$pdf->SetXY(122,51+$remi);
	$pdf->Cell(50, 1, $ced, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(122,56+$remi);
	$pdf->Cell(50, 1, $telefonoD1, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(122,61+$remi);
	$pdf->Cell(50, 1, $telefonoD2, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(80,66+$remi);
	$pdf->Cell(50, 1, $cantidad, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(122,66+$remi);
	$pdf->Cell(50, 1, $kiloAd, 0, 1, 'L', 0, '', 1);
	$pdf->SetXY(166,66+$remi);
	$pdf->Cell(50, 1, $contenido, 0, 1, 'L', 0, '', 1);
	...
	if($hoja[$i] == '**DESTINATARIO**') {
		...
		$pdf->Cell(103, 1, $resolucion, 0, 1, 'L', 0, '', 1);
		...
		$pdf->SetXY(145,97+$remi);
		$pdf->Cell(62, 1, 'Operario: '.$nombre, 0, 1, 'L', 0, '', 1);
	}
