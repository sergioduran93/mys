...
<body>
	<div id="page">
			...
			<div class="container banner">
		        ...
		        <div class="navbar-collapse collapse">
					...
					<div class="user-banner" style="color:#fff;">
						<?php if ($session): ?>
							<?php echo '<div>Bienvenido ' . $this->Html->link($usuario_actual['name']."(".$usuario_actual['Oficina']['nombre'].")", array('controller'=>'users', 'action'=>'perfil',$usuario_actual['id']),array('class'=>'perfil')) . $this->Html->link('<span class="glyphicon glyphicon-log-in"></span>Salir', array('controller'=>'users', 'action'=>'logout'),array('escape'=>false,'class'=>'btn bord','style'=>'padding:0px 15px 0px 9px;color:#333;')).'</div>'; ?>
						<?php else: ?>
		...
		<div id ="margen">
			...
			<nav class="navbar navbar-default banner-nav" role="navigation">
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <button id="btn-limpiar" type="button" class="btn btn-primary" onclick="limpiar();">Limpiar</button>
