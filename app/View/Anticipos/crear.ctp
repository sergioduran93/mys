...
<div class="row" style="width:90%; margin-left:5%;">
	...
	<?php echo $this->Form->create('Anticipo',array('class'=>'form-inline'));?>
	    ...
	    <fieldset>
			    <div class="form-group col-md-12 bs-callout bs-callout-info" style="margin-left: 30px;padding:0px;width:50%;">
			        <div class="col-md-4"><?php echo $this->Form->input('inicio',array('label'=>'Fecha Inicio: ','type'=>'text','placeholder'=>'AAAA-MM-DD','default'=>$fechaActual)); ?></div>
			    ...
			    <div>
				    <div class="form-group col-md-12">
				    	<div class="col-md-4"><?php echo $this->Form->input('oficina',array('label'=>"Oficina: ",'type'=>'select','options'=>$oficinas,'default'=>$usuario_actual['oficina_id'])); ?></div>
			       		<div class="col-md-3"><?php echo $this->Form->input('fecha',array('label'=>'Fecha de retiro: ','type'=>'text','default'=>date("Y-m-d"),'readonly'=>'readonly')); ?></div>
			       		...
			       		<div class="col-md-2"><?php echo $this->Form->input('retiro_no',array('label'=>'Retiro No: ','type'=>'text','default'=>$num,'readonly'=>'readonly')); ?></div>
					</div>
				    <div class="form-group col-md-12">
			       		<div class="col-md-6"><?php echo $this->Form->input('valor',array('label'=>'Valor: ','type'=>'text','class'=>'form-control','data-bv-notempty'=>'true')); ?></div>
			       		<div class="col-md-6"><?php echo $this->Form->input('transaccion',array('label'=>'Transacción No.: ','type'=>'text','class'=>'form-control','data-bv-notempty'=>'true')); ?></div>
					</div>
				</div>
	...
	<?php echo $this->Form->button("Guardar",array('type'=>'submit','id'=>'btn-submit',"class"=>'btn btn-primary',"style"=>'float:right;margin-bottom: 15px;'));?>
...
$(document).ready(function(){
	...
	$('#AnticipoCrearForm').bootstrapValidator({
		feedbackIcons: {
