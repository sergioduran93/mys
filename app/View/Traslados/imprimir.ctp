...
$pdf    = new Planilla('l', 'mm', array($largoM,$altoM), true, 'UTF-8', false);
	...
	$pdf->MultiCell(140, 1, "PLANILLA DE TRASLADO LOCAL # ".$id, 0, 'C', 0, 0, '40', '11', true);
	...
	$pdf->MultiCell(120, 1, $despa['Traslado']['origen'].' - '.$despa['Traslado']['destino'], 0, 'C', 0, 0, '45', '16', true);
	$pdf->MultiCell(40, 1, $despa['Traslado']['fecha'], 0, 'R', 0, 0, '165', '16', true);
	...
	$pdf->MultiCell(80, 1, $vehiculo['Conductor']['celular'], 0, 'L', 0, 0, '120', '31', true);
	$altoGuia = -5;
	...
	$pdf->MultiCell(50, 1, 'Total: '.$despa['Traslado']['valor'], 0, 'R', 0, 0, '156', 46+$altoGuia, true);
...
<script>
var link = <?php echo "'".$this->Html->link('Registrar Traslado Local', array('controller'=>'despachos','action'=>'traslado'),array('class'=>'btn btn-success'))."'";?>;
