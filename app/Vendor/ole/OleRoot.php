...
class OleRoot extends OlePps
{
    ...
    */
    public function OleRoot($time_1st, $time_2nd, $raChild)
    {
        $this->_tmp_dir = '';
        $this->OlePps(
           null,
    ...
    public function save($filename)
    {
        ...
        if (($filename == '-') or ($filename == ''))
        {
            ...
            if ($this->_FILEH_ == false) {
                trigger_error("Can't create temporary file.", E_ERROR);
            }
        }
        else
        {
            ...
            if ($this->_FILEH_ == false) {
                trigger_error("Can't open $filename. It may be in use or protected.", E_ERROR);
            }
        }
    ...
    */
    ...
    /**
    * Helper private function for caculating a magic value for block sizes
    *
    * @access private
