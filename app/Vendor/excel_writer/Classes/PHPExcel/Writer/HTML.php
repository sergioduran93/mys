...
class PHPExcel_Writer_HTML extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter {
	...
	public function generateHTMLHeader($pIncludeStyles = false) {
		...
		$html .= '<link rel="stylesheet" type="text/css" href="'.Router::url('/').'css/tableCustom.css">' . PHP_EOL;
		$html .= '  </head>' . PHP_EOL;
		$html .= '' . PHP_EOL;
		$html .= '  <body id="'.htmlspecialchars($properties->getTitle()).'"><center>' . PHP_EOL;
