...
class Spreadsheet_Excel_Writer_Worksheet extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @return array
    */
    private function _substituteCellref($cell)
    {
    ...
    */
    private function _encodePassword($plaintext)
    {
        $password = 0x0000;
        $i        = 1;       // char position
    ...
    */
    private function _checkRowCol($row, $col)
    {
        if ($row >= $this->_xls_rowmax) {
            return false;
        }
    ...
    */
    ...
    private function _writeUrlRange($row1, $col1, $row2, $col2, $url, $string = '', $format = null)
    {
    ...
    * @return integer
    */
    private function _writeUrlWeb($row1, $col1, $row2, $col2, $url, $str, $format = null)
    {
    ...
    * @return integer
    */
    private function _writeUrlInternal($row1, $col1, $row2, $col2, $url, $str, $format = null)
    {
        $record      = 0x01B8;                       // Record identifier
        $length      = 0x00000;                      // Bytes to follow
    ...
    * @return integer
    */
    private function _writeUrlExternal($row1, $col1, $row2, $col2, $url, $str, $format = null)
    {
    ...
    * @access private
    */
    private function _storeDimensions()
    {
    ...
    * @access private
    */
    private function _storeWindow2()
    {
    ...
    */
    private function _storeColinfo($col_array)
    {
    ...
    * @see setSelection()
    */
    private function _storeSelection($array)
    {
    ...
    * @access private
    */
    private function _storeMergedCells()
    {
    ...
    */
    private function _storeExterncount($count)
    {
    ...
    */
    private function _storeExternsheet($sheetname)
    {
    ...
    *                     4 => Active pane
    */
    private function _storePanes($panes)
    {
        $y       = $panes[0];
        $x       = $panes[1];
        $rwTop   = $panes[2];
    ...
    * @access private
    */
    private function _storeHcenter()
    {
    ...
    * @access private
    */
    private function _storeVcenter()
    {
    ...
    * @access private
    */
    private function _storeMarginLeft()
    {
    ...
    * @access private
    */
    private function _storeMarginRight()
    {
    ...
    * @access private
    */
    private function _storeMarginTop()
    {
    ...
    * @access private
    */
    private function _storeMarginBottom()
    {
    ...
    * @access private
    */
    private function _storePrintHeaders()
    {
    ...
    * @access private
    */
    private function _storePrintGridlines()
    {
    ...
    * @access private
    */
    private function _storeGridset()
    {
    ...
    * @access private
    */
    private function _storeProtect()
    {
    ...
    * @access private
    */
    private function _storePassword()
    {
    ...
    */
    private function _positionImage($col_start, $row_start, $x1, $y1, $width, $height)
    {
    ...
    */
    private function _storeObjPicture($colL,$dxL,$rwT,$dyT,$colR,$dxR,$rwB,$dyB)
    {
    ...
    */
    private function _processBitmap($bitmap)
    {
        // Open file.
