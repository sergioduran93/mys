...
class Spreadsheet_Excel_Writer_Parser extends PEAR
{
    ...
    */
    ...
    /**
    * Convert a private function to a ptgFunc or ptgFuncVarV depending on the number of
    * args that it takes.
    *
    * @access private
    * @param string  $token    The name of the private function for convertion to ptg value.
    * @param integer $num_args The number of arguments the private function receives.
    * @return string The packed ptg for the private function
    */
    ...
    private function _match($token)
    {
        switch($token) {
            ...
            default:
                ...
                // if it's a private function call
    ...
    */
    ...
    /**
    * It parses a private function call. It assumes the following rule:
    * Func -> ( Expr [,Expr]* )
    *
    * @access private
    * @return mixed The parsed ptg'd tree on success, PEAR_Error on failure
    ...
    */
    private function toReversePolish($tree = array())
    {
