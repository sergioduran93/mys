...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    * @return mixed true on success. PEAR_Error on failure
    */
    private function _storeWorkbook()
    {
    ...
    * @return mixed true on success. PEAR_Error on failure
    */
    private function _storeOLEFile()
    {
        if($this->_BIFF_version == 0x0600) {
    ...
    * @access private
    */
    private function _storeAllFonts()
    {
    ...
    * @access private
    */
    private function _storeAllNumFormats()
    {
    ...
    * @access private
    */
    private function _storeAllStyles()
    {
        $this->_storeStyle();
    }
    ...
    * @access private
    */
    private function _storeExterns()
    ...
    * @access private
    */
    private function _storeCodepage()
    {
    ...
    * @access private
    */
    private function _storeWindow1()
    {
    ...
    * @access private
    */
    private function _storeBoundsheet($sheetname,$offset)
    {
    ...
    * @access private
    */
    private function _storeSupbookInternal()
    {
    ...
    * @access private
    */
    private function _storeExternsheetBiff8()
    {
    ...
    * @access private
    */
    private function _storeNumFormat($format, $ifmt)
    {
    ...
    * @access private
    */
    private function _storeDatemode()
    {
    ...
    * @access private
    */
    private function _storeExterncount($cxals)
    {
    ...
    * @access private
    */
    private function _storeNameShort($index, $type, $rowmin, $rowmax, $colmin, $colmax)
    {
    ...
    * @access private
    */
    private function _storeNameLong($index, $type, $rowmin, $rowmax, $colmin, $colmax)
    {
        $record          = 0x0018;       // Record identifier
    ...
    * @access private
    */
    private function _storeCountry()
    {
    ...
    * @access private
    */
    private function _storePalette()
    {
        $aref            = $this->_palette;
    ...
    * @access private
    */
    private function _calculateSharedStringsSizes()
    {
    ...
    * @access private
    */
    private function _storeSharedStringsTable()
    {
