            ...
            switch (direction) {
              case 'left':
                ...
                $('.tooltip:last').css({
                  left: rightPosition,
                  top: topPosition
                }).addClass('left').fadeIn(settings.fadeSpeed).fadeOut(settings.fadeOut);
                break;
              case 'bottom':
                ...
                $('.tooltip:last').css({
                  left: leftPosition,
                  top: topPosition
                }).addClass('bottom').fadeIn(settings.fadeSpeed).fadeOut(settings.fadeOut);
                break;
              case 'top':
                ...
                $('.tooltip:last').css({
                  left: leftPosition,
                  top: topPosition
                }).addClass('top').fadeIn(settings.fadeSpeed).fadeOut(settings.fadeOut);
                break;
              default:
                ...
                $('.tooltip:last').css({
                  left: leftPosition,
                  top: topPosition
                }).fadeIn(settings.fadeSpeed).fadeOut(settings.fadeOut);
            }
